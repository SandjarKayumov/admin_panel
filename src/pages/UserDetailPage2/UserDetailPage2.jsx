...
const UserDetailPage2 = () => {
  ...
  return (
    <div>
      ...
      <Link to="/user-list-two"  style={{display:"flex", justifyContent:"center", marginTop:"50px"}}><Button variant="contained">back to all users</Button></Link>
    </div>
  );
};

export default UserDetailPage2;
